...
class ReceivedMessageContainer extends Component {
    render() {
        return (
            <div style={{transform:'rotate(180deg)', marginLeft:'8px', marginRight:'8px', width:'80%', float:'right'}}>
                <div className='row'>
                    <div className='col' style={{width:'50px', float:'left'}}>
                        <img
