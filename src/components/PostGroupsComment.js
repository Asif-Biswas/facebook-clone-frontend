...
class PostGroupsComment extends Component {
    constructor(props){
        super(props)
        this.state={
            name:'',
            ...
            return (
                <div className=''>
                    <div className="row">
                        ...
                        <p onClick={this.postComment} className='padding-small grey hover-white' style={{cursor:'pointer'}}>Post</p>
                        </div>
...
export default PostGroupsComment;